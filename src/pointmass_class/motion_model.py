...
def motion_model(self, state_dim=2):
...
def forward_kinematic(self, state_dim=2):
...
def end_effector_pose_func(self, state_dim=2):
    return self.forward_kinematic(state_dim)